  ...
  return (
    <>
      ...
      >
        ...
        >
          <p className=" text-xl font-medium  ">Our Company</p>

          <p className={`${styles.boldText100}  text-center mt-[5px] `}>
            Our Company About{" "}
            <span className="text-[white] font-bold ">LOWKEY</span> Logistics
          </p>

          <p className=" md:w-[80%] md:text-xl text-center md:text-left mt-1 text-[15px] ">
            ...
            This made us have a customer base that is very stable with a lot of
            extremely long-term customer relationship that is based on our
            constant ability to provide exceptional service.
          </p>

          <button
            className={`${styles.btnPadding} fa-bounce bg-[lime] font-medium md:text-2xl md:font-bold `}
          >
            Know More
          </button>
        </section>
